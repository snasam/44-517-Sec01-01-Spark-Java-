...
public class MinimalPageRankAnusha {
  ...
  public static void main(String[] args) {
   ...
   PCollection<KV<String,String>> p1 = AnushaMapper01(p,"go.md",dataFolder);
   PCollection<KV<String,String>> p2 = AnushaMapper01(p,"python.md",dataFolder);
   PCollection<KV<String,String>> p3 = AnushaMapper01(p,"java.md",dataFolder);
   PCollection<KV<String,String>> p4 = AnushaMapper01(p,"README.md",dataFolder);
    ...
    pLinksString.apply(TextIO.write().to("AnushaPR"));  
    p.run().waitUntilFinish();
  }

  public static PCollection<KV<String,String>> AnushaMapper01(Pipeline p, String filename, String dataFolder){
