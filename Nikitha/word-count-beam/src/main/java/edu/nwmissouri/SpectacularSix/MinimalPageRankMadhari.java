...
public class MinimalPageRankMadhari  {
  ...
  public static void main(String[] args) {
   ...
   PCollection<KV<String,String>> p1 = MadhariMapper01(p,"go.md",dataFolder);
   PCollection<KV<String,String>> p2 = MadhariMapper01(p,"python.md",dataFolder);
   PCollection<KV<String,String>> p3 = MadhariMapper01(p,"java.md",dataFolder);
   PCollection<KV<String,String>> p4 = MadhariMapper01(p,"README.md",dataFolder);
    ...
    pLinksString.apply(TextIO.write().to("MadhariPR"));  
    p.run().waitUntilFinish();
  }

  public static PCollection<KV<String,String>> MadhariMapper01(Pipeline p, String filename, String dataFolder){
